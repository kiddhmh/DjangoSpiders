...
class WechatSogouAPI(object):
    ...
    def search_all_article(self, keyword, page=1, resultList=[]):
        result = self.search_article(keyword, page)
        if len(result) == 0:
            return resultList
        else:
            ...
            page += 1
            time.sleep(10 )
            return self.search_all_article(keyword, page, resultList)
                        
                        
    def search_all(self, keyword):
        return self.search_all_article(keyword)
